...
public class ExpenseCreationPresenterTest {
    ...
    @Test
    public void testLoadPaymentMethods_successfulObtainingList() {
    ...
    @Test
    public void testGetPaymentMethodsByType_withCashPaymentMethod() throws IllegalAccessException {

        OtherPaymentMethodModel otherPaymentMethodModelOne = ModelsFactory.createOtherPaymentMethodModel();
        otherPaymentMethodModelOne.setTypePaymentMethod(TypePaymentMethodEnum.CASH);

        OtherPaymentMethodModel otherPaymentMethodModelTwo = ModelsFactory.createOtherPaymentMethodModel();
        otherPaymentMethodModelTwo.setTypePaymentMethod(TypePaymentMethodEnum.FOOD_COUPONS);

        OtherPaymentMethodModel otherPaymentMethodModelThree = ModelsFactory.createOtherPaymentMethodModel();
        otherPaymentMethodModelThree.setTypePaymentMethod(TypePaymentMethodEnum.CHEQUE);

        List<OtherPaymentMethodModel> otherPaymentMethodModelList = new ArrayList<>();
        otherPaymentMethodModelList.add(otherPaymentMethodModelOne);
        otherPaymentMethodModelList.add(otherPaymentMethodModelTwo);
        otherPaymentMethodModelList.add(otherPaymentMethodModelThree);

        MemberModifier.field(ExpenseCreationPresenterImpl.class, "mOtherPaymentMethodModels").
                set(mExpenseCreationPresenter, otherPaymentMethodModelList);

        mExpenseCreationPresenter.getPaymentMethodsByType(TypePaymentMethodEnum.CASH);

        verify(mExpenseCreationActivity).
                showOtherPaymentMethods(argThat(new IsAList<OtherPaymentMethodModel>().size(1)));

    }

    @Test
    public void testGetPaymentMethodsByType_withCashPaymentMethod_withNoItems() throws IllegalAccessException {

        MemberModifier.field(ExpenseCreationPresenterImpl.class, "mOtherPaymentMethodModels").
                set(mExpenseCreationPresenter, new ArrayList<OtherPaymentMethodModel>());

        mExpenseCreationPresenter.getPaymentMethodsByType(TypePaymentMethodEnum.CASH);

        verify(mExpenseCreationActivity).
                showOtherPaymentMethods(argThat(new IsAList<OtherPaymentMethodModel>().size(0)));
    }

    @Test
    public void testGetPaymentMethodsByType_withCardType() throws IllegalAccessException {

        List<BankCardModel> bankCardModels =  new ArrayList<>();
        bankCardModels.add(ModelsFactory.createBankCardModel());
        bankCardModels.add(ModelsFactory.createBankCardModel());

        MemberModifier.field(ExpenseCreationPresenterImpl.class, "mBankCardModels").
                set(mExpenseCreationPresenter, bankCardModels);

        mExpenseCreationPresenter.getPaymentMethodsByType(TypePaymentMethodEnum.CARD);

        verify(mExpenseCreationActivity).
                showBankCards(argThat(new IsAList<BankCardModel>().size(2)));
    }

    @Test
    public void testGetPaymentMethodsByType_withCardType_withNoItems() throws IllegalAccessException {

        MemberModifier.field(ExpenseCreationPresenterImpl.class, "mBankCardModels").
                set(mExpenseCreationPresenter, new ArrayList<BankCardModel>());

        mExpenseCreationPresenter.getPaymentMethodsByType(TypePaymentMethodEnum.CARD);

        verify(mExpenseCreationActivity).
                showBankCards(argThat(new IsAList<BankCardModel>().size(0)));
