...
public class WelcomeAdapterTest {
    ...
    public void testGetItemView_successfulConstruction() {
        ...
        when(container.findViewById(R.id.image_option)).thenReturn(image);

        TextView title = mock(TextView.class);
        when(container.findViewById(R.id.text_option_title)).thenReturn(title);
        ...
        verify(container).findViewById(R.id.image_option);
        verify(container).findViewById(R.id.text_option_title);
        verify(container).findViewById(R.id.text_option_description);
        verify(image).setImageResource(R.drawable.ic_cash);
        verify(title).setText(R.string.title_option_1);
        verify(description).setText(R.string.msg_description_1);
